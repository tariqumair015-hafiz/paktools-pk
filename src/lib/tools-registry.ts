...
export const tools: ToolMeta[] = [
  ...
  { slug: "car-loan-calculator", name: "Car Loan Calculator", short: "Monthly installment calculator.", description: "Calculate monthly car installment for any Pakistani bank.", category: "finance", icon: Calculator, keywords: "car loan, installment, Meezan, HBL, Pakistan", usage: 8500 },
  ...
  { slug: "govt-salary-calculator", name: "Govt Salary Calculator", short: "BPS grade salary.", description: "Calculate Pakistan government employee salary by BPS grade.", category: "finance", icon: Building2, keywords: "govt salary, BPS, government employee, Pakistan", usage: 9200 },
  ...
  { slug: "gold-price-calculator", name: "Gold Price Calculator", short: "Tola/gram gold value.", description: "Calculate gold price in Pakistan for any weight and karat.", category: "finance", icon: Gem, keywords: "gold price, tola, Pakistan, 24K, 22K", usage: 7600 },
  ...
  { slug: "inflation-calculator", name: "Inflation Calculator", short: "Pakistan money value over time.", description: "Calculate the real value of money considering Pakistan inflation rate.", category: "finance", icon: TrendingUp, keywords: "inflation, Pakistan, money value, purchasing power", usage: 4200 },
